    ...
    <div class="row">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Data Pembimbing</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            {{ Form::model($data, ['route' => ['pembimbing.update', $data->nik_nip], 'enctype' => 'multipart/form-data']) }}
              @csrf
              @method('PUT')
                <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <a href="{{ route('pembimbing.index') }}" class="btn btn-md bg-navy btn-flat"> <i class="fa fa-chevron-circle-left"></i> </a>
                </div>
            {{ Form::close() }}
        </div>
    </div>
